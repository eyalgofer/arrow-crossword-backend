...
export class PuzzleGenerator {
  ...
  addGeneratedTemplates(): void {
    // Add a mix of sizes for variety
    this.addGeneratedTemplate('small', Difficulty.EASY);
    this.addGeneratedTemplate('small', Difficulty.MEDIUM);
    this.addGeneratedTemplate('medium', Difficulty.EASY);
    this.addGeneratedTemplate('medium', Difficulty.MEDIUM);
    this.addGeneratedTemplate('large', Difficulty.MEDIUM);
    this.addGeneratedTemplate('large', Difficulty.HARD);
    this.addGeneratedTemplate('xlarge', Difficulty.HARD);
  }
