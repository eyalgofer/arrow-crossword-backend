...
// Medium complexity template - 5x5 grid
const MEDIUM_PUZZLE: Puzzle = {
  ...
  clues: [
    { number: 1, direction: 'across', clue: 'Feline', answer: 'CAT', enumeration: [3], startRow: 0, startCol: 0 },
    { number: 2, direction: 'right-down', clue: 'Preposition', answer: 'AT', enumeration: [2], startRow: 0, startCol: 1 },
    { number: 3, direction: 'across', clue: 'Consumed', answer: 'ATE', enumeration: [3], startRow: 1, startCol: 0 },
    { number: 4, direction: 'down', clue: 'Feline', answer: 'CAT', enumeration: [3], startRow: 0, startCol: 3 },
    { number: 5, direction: 'across', clue: 'Sticky substance', answer: 'TAR', enumeration: [3], startRow: 2, startCol: 0 },
    { number: 6, direction: 'down', clue: 'Preposition', answer: 'AT', enumeration: [2], startRow: 1, startCol: 2 },
    { number: 7, direction: 'across', clue: 'Consumed', answer: 'ATE', enumeration: [3], startRow: 3, startCol: 0 },
    { number: 8, direction: 'down', clue: 'Sticky substance', answer: 'TAR', enumeration: [3], startRow: 2, startCol: 4 }
  ],
  estimatedTime: 60,
  coinReward: 8
};
...
export class PuzzleGenerator {
  ...
  addSimpleTemplate(): void {
    this.addTemplateFromPuzzle(GOOD_EXAMPLE_PUZZLE);
  }
...
export function generatePuzzles(
  ...
  generator.addTemplateFromPuzzle(MEDIUM_PUZZLE);
  // Add more complex template for variety (commented out if too difficult)
...
export { GOOD_EXAMPLE_PUZZLE, SIMPLE_PUZZLE, MEDIUM_PUZZLE, WORD_LIST, getClue };