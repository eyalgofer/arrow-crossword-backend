...
function getAllowedFieldTypes(mask: Mask, row: number, col: number): FieldType[] {
  ...
  // Type 3: needs cell diagonally down-right and then at least 1 more below
  if (row < mask.rows - 2 && col < mask.cols - 1) allowed.push('3');
  
  // Type 4: needs cell diagonally down-left and then at least 1 more below
  if (row < mask.rows - 2 && col > 0) allowed.push('4');
  
  // Type 5: needs cell below and then at least 1 more to the right
  if (row < mask.rows - 1 && col < mask.cols - 2) allowed.push('5');
  
  // Type 6: needs cell above-right and then at least 1 more to the right
  if (row > 0 && col < mask.cols - 2) allowed.push('6');
